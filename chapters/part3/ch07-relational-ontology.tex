...
\emph{\bahai writings}: ``One single reality with manifold expressions owing to the diversity of its instruments'' \citep[para.~35]{SummonsLordHosts}. The plurality of things is a plurality of relational expressions, not a plurality of independent substances. Existence is constituted by relational affinity; without affinity, integrated being dissolves \citep[Talk 41, Talk 48]{PUP}. Denial: no plurality of independent substances underlying the manifest diversity. Affirmation: relational affinity constitutes existence as such.
