...
In the framework of the Relational Coherence Framework that I have developed elsewhere~\citep{AdamsRCT}, this transition can be described in terms of the Affinity Operator.
The Affinity Operator $\alpha$ captures the degree of quantum relational coherence between two systems --- the strength of their relational bond at the quantum level.
...
In the Relational Coherence Framework~\citep{AdamsRCT}, this is the collapse of the Affinity Operator: $\alpha \to 0$ as relational affinity is extinguished and the system's quantum relational being dissolves into classical separateness.
