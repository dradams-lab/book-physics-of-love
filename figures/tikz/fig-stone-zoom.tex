...
\begin{scope}[shift={(7.55,0)}]
  ...
  \node[anchor=north, text width=5.8cm, align=center] at (3.3,1.85)
    {\small\textit{Electrons, quarks, relational exchange ---}\\[2pt]
     \small\textit{ceaseless quantum activity}};

  % Quote below caption
  \node[anchor=north, text width=5.8cm, align=center] at (3.3,0.90)
