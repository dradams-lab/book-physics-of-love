...
\begin{scope}[shift={(7.55,0)}]
  ...
  \node[anchor=north, text width=5.8cm, align=center] at (3.3,1.35)
    {\small\textit{Electrons, quarks, relational exchange ---}\\[1pt]
     \small\textit{ceaseless quantum activity}};

  % Quote at very bottom
  \node[anchor=north, text width=5.8cm, align=center] at (3.3,0.60)
    {\footnotesize\textcolor{emphred}{\textit{``Motion is life.''}}\\[-1pt]
     \footnotesize --- `Abdu'l-Bah\'a};
\end{scope}
